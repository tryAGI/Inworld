...
namespace Inworld
{
    ...
    public partial class ApiException : global::System.Exception
    {
            ...
            global::System.Collections.Generic.IDictionary<string, global::System.Collections.Generic.IEnumerable<string>>? responseHeaders = null)
        {
            ...
            {
                case 401: return new global::Inworld.AuthenticationException(message, innerException);
                case 402: return new global::Inworld.PaymentRequiredException(message, innerException);
                case 403: return new global::Inworld.AuthorizationException(message, innerException);
                case 404: return new global::Inworld.NotFoundException(message, innerException);
                case 408: return new global::Inworld.RequestTimeoutException(message, innerException);
                case 409: return new global::Inworld.ConflictException(message, innerException);
                case 422: return new global::Inworld.ValidationException(message, innerException);
                case 429:
                {
                    var retryAfter = global::Inworld.ApiException.TryParseRetryAfter(responseHeaders);
                    return new global::Inworld.RateLimitException(message, innerException) { RetryAfter = retryAfter };
                }
            }

            if ((int)statusCode >= 500 && (int)statusCode <= 599)
            {
                return new global::Inworld.ServerException(message, innerException, statusCode);
            }
    ...
    public partial class ApiException<T> : ApiException
    {
            ...
            global::System.Collections.Generic.IDictionary<string, global::System.Collections.Generic.IEnumerable<string>>? responseHeaders = null)
        {
            switch ((int)statusCode)
            {
                case 401: return new global::Inworld.AuthenticationException<T>(message, innerException);
                case 402: return new global::Inworld.PaymentRequiredException<T>(message, innerException);
                case 403: return new global::Inworld.AuthorizationException<T>(message, innerException);
                case 404: return new global::Inworld.NotFoundException<T>(message, innerException);
                case 408: return new global::Inworld.RequestTimeoutException<T>(message, innerException);
                case 409: return new global::Inworld.ConflictException<T>(message, innerException);
                case 422: return new global::Inworld.ValidationException<T>(message, innerException);
                case 429:
                {
                    var retryAfter = global::Inworld.ApiException.TryParseRetryAfter(responseHeaders);
                    return new global::Inworld.RateLimitException<T>(message, innerException) { RetryAfter = retryAfter };
                }
            }

            if ((int)statusCode >= 500 && (int)statusCode <= 599)
            {
                return new global::Inworld.ServerException<T>(message, innerException, statusCode);
            }
    ...
    [global::System.Serializable]
    public partial class AuthenticationException : global::Inworld.ApiException
    {
        /// <inheritdoc />
    ...
    [global::System.Serializable]
    public partial class AuthenticationException<T> : global::Inworld.ApiException<T>
    {
        /// <inheritdoc />
        public AuthenticationException() : base("Authentication failed.", global::System.Net.HttpStatusCode.Unauthorized) { }
        /// <inheritdoc />
    ...
    [global::System.Serializable]
    public partial class PaymentRequiredException : global::Inworld.ApiException
    {
        /// <inheritdoc />
    ...
    [global::System.Serializable]
    public partial class PaymentRequiredException<T> : global::Inworld.ApiException<T>
    {
        /// <inheritdoc />
        public PaymentRequiredException() : base("Payment required.", global::System.Net.HttpStatusCode.PaymentRequired) { }
        /// <inheritdoc />
    ...
    [global::System.Serializable]
    public partial class AuthorizationException : global::Inworld.ApiException
    {
        /// <inheritdoc />
    ...
    [global::System.Serializable]
    public partial class AuthorizationException<T> : global::Inworld.ApiException<T>
    {
        /// <inheritdoc />
        public AuthorizationException() : base("Authorization failed.", global::System.Net.HttpStatusCode.Forbidden) { }
        /// <inheritdoc />
    ...
    [global::System.Serializable]
    public partial class NotFoundException : global::Inworld.ApiException
    {
        /// <inheritdoc />
    ...
    [global::System.Serializable]
    public partial class NotFoundException<T> : global::Inworld.ApiException<T>
    {
        /// <inheritdoc />
        public NotFoundException() : base("Resource not found.", global::System.Net.HttpStatusCode.NotFound) { }
        /// <inheritdoc />
    ...
    [global::System.Serializable]
    public partial class RequestTimeoutException : global::Inworld.ApiException
    {
        /// <inheritdoc />
    ...
    [global::System.Serializable]
    public partial class RequestTimeoutException<T> : global::Inworld.ApiException<T>
    {
        /// <inheritdoc />
        public RequestTimeoutException() : base("Request timed out.", global::System.Net.HttpStatusCode.RequestTimeout) { }
        /// <inheritdoc />
    ...
    [global::System.Serializable]
    public partial class ConflictException : global::Inworld.ApiException
    {
        /// <inheritdoc />
    ...
    [global::System.Serializable]
    public partial class ConflictException<T> : global::Inworld.ApiException<T>
    {
        /// <inheritdoc />
        public ConflictException() : base("Conflict.", global::System.Net.HttpStatusCode.Conflict) { }
        /// <inheritdoc />
    ...
    [global::System.Serializable]
    public partial class ValidationException : global::Inworld.ApiException
    {
        /// <inheritdoc />
    ...
    [global::System.Serializable]
    public partial class ValidationException<T> : global::Inworld.ApiException<T>
    {
        /// <inheritdoc />
        public ValidationException() : base("Validation failed.", (global::System.Net.HttpStatusCode)422) { }
        /// <inheritdoc />
    ...
    [global::System.Serializable]
    public partial class RateLimitException : global::Inworld.ApiException
    {
    ...
    [global::System.Serializable]
    public partial class RateLimitException<T> : global::Inworld.ApiException<T>
    {
        /// <summary>The parsed <c>Retry-After</c> delay, if present on the response.</summary>
        public global::System.TimeSpan? RetryAfter { get; set; }
    ...
    [global::System.Serializable]
    public partial class ServerException : global::Inworld.ApiException
    {
        /// <inheritdoc />
    ...
    [global::System.Serializable]
    public partial class ServerException<T> : global::Inworld.ApiException<T>
    {
        /// <inheritdoc />
        public ServerException() : base("Server error.", global::System.Net.HttpStatusCode.InternalServerError) { }
        /// <inheritdoc />
