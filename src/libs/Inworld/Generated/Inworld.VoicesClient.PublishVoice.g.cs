...
namespace Inworld
{
    public partial class VoicesClient
    {
        ...
        private static readonly global::Inworld.EndPointSecurityRequirement s_PublishVoiceSecurityRequirement0 =
        ...
        private static readonly global::Inworld.EndPointSecurityRequirement[] s_PublishVoiceSecurityRequirements =
            new global::Inworld.EndPointSecurityRequirement[]
            {                s_PublishVoiceSecurityRequirement0,
            };
        partial void PreparePublishVoiceArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string voiceId,
            global::Inworld.PublishVoiceRequest request);
        partial void PreparePublishVoiceRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string voiceId,
            global::Inworld.PublishVoiceRequest request);
        partial void ProcessPublishVoiceResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPublishVoiceResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Inworld.Voice> PublishVoiceAsync(
            string voiceId,
        ...
        {
            var __response = await PublishVoiceAsResponseAsync(
                voiceId: voiceId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Inworld.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Inworld.AutoSDKHttpResponse<global::Inworld.Voice>> PublishVoiceAsResponseAsync(
            string voiceId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Inworld.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PublishVoiceSecurityRequirements,
                operationName: "PublishVoiceAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Inworld.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Inworld.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "PublishVoiceAsync",
                                pathTemplate: "$\"/voices/v1/voices/{voiceId}:publish\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Inworld.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPublishVoiceResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Inworld.Voice.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Inworld.AutoSDKHttpResponse<global::Inworld.Voice>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Inworld.Voice.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Inworld.Voice> PublishVoiceAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Inworld.PublishVoiceRequest
            {
            ...
            return await PublishVoiceAsync(
                voiceId: voiceId,
                request: __request,
                requestOptions: requestOptions,
