...
namespace Inworld
{
    ...
    public static class AutoSDKPager
    {
        ...
        public static global::Inworld.AutoSDKRequestOptions CreatePageRequestOptions(
        ...
        public static global::System.Collections.Generic.IAsyncEnumerable<TItem> LinkHeaderAsync<TPage, TItem>(
            global::System.Func<string?, global::System.Threading.CancellationToken, global::System.Threading.Tasks.Task<global::Inworld.AutoSDKHttpResponse<TPage>>> fetchPage,
            global::System.Func<TPage, global::System.Collections.Generic.IEnumerable<TItem>?> extractItems,
            string? initialUrl = null,
            string linkRel = "next",
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            extractItems = extractItems ?? throw new global::System.ArgumentNullException(nameof(extractItems));
            return LinkHeaderAsync<global::Inworld.AutoSDKHttpResponse<TPage>, TItem>(
                fetchPage: fetchPage,
