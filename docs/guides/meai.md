...
The Inworld SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package Inworld
```
...
using var client = new InworldClient(
    apiKey: Environment.GetEnvironmentVariable("INWORLD_API_KEY")!);
